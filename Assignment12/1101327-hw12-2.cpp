...
int difference(Date departureDate, Date currentDate)
{
    ...
    tm tm1 = {};
    tm1.tm_year = departureDate.year - 1900;
    tm1.tm_mon = departureDate.month - 1;
    tm1.tm_mday = departureDate.day;

    tm tm2 = {};
    tm2.tm_year = currentDate.year - 1900;
    tm2.tm_mon = currentDate.month - 1;
    tm2.tm_mday = currentDate.day;
